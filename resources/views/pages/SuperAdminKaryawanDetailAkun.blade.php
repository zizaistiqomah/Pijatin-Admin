        ...
        <div class="bg-white rounded-[10px] shadow p-4 w-[470px]">
            ...
            <div class="space-y-2 text-xs text-gray-700">
                <div class="flex justify-between border-b pb-1">
                    ...
                    <span class="font-medium text-gray-800">ADM129</span>
                </div>
                <div class="flex justify-between border-b pb-1">
                    <span class="text-gray-500">Peran Akun</span>
                    <span class="font-medium text-gray-800">Administrasi</span>
                </div>
                <div class="flex justify-between border-b pb-1">
                    <span class="text-gray-500">Alamat Email</span>
                    <span class="font-medium text-gray-800">nabilausamah@gmail.com</span>
                </div>
                <div class="flex justify-between border-b pb-1">
                ...
                <div class="flex justify-between border-b pb-1">
                    ...
                    <span class="font-medium text-gray-800">Lembang, Bandung</span>
                </div>
            </div>
        ...
        <div class="bg-white rounded-[10px] shadow p-4 w-[450px] h-60">
            ...
            <div class="space-y-2 text-xs text-gray-700">
                <div class="flex justify-between border-b pb-1">
                    ...
                    <span class="font-medium text-gray-800">Nabila Usamah</span>
                </div>
                <div class="flex justify-between border-b pb-1">
                    <span class="text-gray-500">Tempat Lahir</span>
                    <span class="font-medium text-gray-800">Jakarta Barat</span>
                </div>
                <div class="flex justify-between border-b pb-1">
                    <span class="text-gray-500">Tanggal Lahir</span>
                    <span class="font-medium text-gray-800">12 Februari 2000</span>
                </div>
                <div class="flex justify-between border-b pb-1">
                ...
                <div class="flex justify-between border-b pb-1">
                    ...
                    <span class="font-medium text-gray-800">Kapuk, Cengkareng, Jakarta Barat</span>
                </div>
            </div>
        </div>
    </div>
