...
<div class="bg-[#EBFFF2] min-h-screen">
    ...
    <div class="mt-[14px] ml-[26px] mr-[26px] px-6 py-20 bg-[#EBFFF2] flex justify-between items-center">
        <h2 class="text-xl font-bold text-gray-700">Selesai</h2>
    </div>
                ...
                <tbody>
                    @foreach ($orders as $index => $order)
                        <tr class="hover:bg-gray-50">
                            ...
                            {{-- STATUS --}}
                            <td class="px-4 py-2">
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-green-200 text-green-700">
